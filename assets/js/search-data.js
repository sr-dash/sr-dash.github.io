...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-joined-national-solar-observatory-as-brinson-postdoctoral-resarch-associate",
          title: 'Joined National Solar Observatory as Brinson Postdoctoral Resarch Associate.',
          description: "",
