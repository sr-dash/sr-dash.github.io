...
The (DKIST) currently provides the highest-resolution solar observations ever obtained.
...
The Parker Solar Probe has fundamentally transformed solar physics by becoming the first spacecraft to directly sample the solar corona.
