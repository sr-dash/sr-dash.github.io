---
layout: post
title: "Configuring a New System with the Libraries Needed to Compile MHD Models"
date: 2025-01-15
category: methods
tags: [HPC Configuration, Linux Deployment, OpenMPI, netCDF, Build Toolchain]
excerpt: "A practical walkthrough for standing up GCC, OpenMPI, HDF5 and netCDF on a fresh machine so that simulation codes such as SWMF, MPI-AMRVAC and SFT-1D will build."
---
...
continuing working on the modelling. In this post I will try to summarize the libraries required for setting up some of the simulations codes e.g., 
